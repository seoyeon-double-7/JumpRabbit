...
public class GamePanel extends JPanel {
	...
	public static final Color RabbitPink = new Color(255, 57, 209);
	...
	private int gameSpeed = 12; // 게임 속도
	...
	public GamePanel(JFrame superFrame, CardLayout cl) {
		...
		// 일시정지 버튼
		escButton = new JButton(new ImageIcon("img/icon_esc_return.png"));
		escButton.setBounds(500, 400, 210, 57);
		escButton.setHorizontalAlignment(JButton.CENTER);
		escButton.setBorderPainted(false); // 버튼 윤곽선 없애기
		escButton.setContentAreaFilled(false); // 버튼 투명 채우기
	...
	// 게임을 세팅한다
	public void gameSet(Rabbitimg ci) {

		setFocusable(true);

		initCookieImg(ci); // rabbit이미지를 세팅
	...
	protected void paintComponent(Graphics g) {
		...
		buffg.drawImage(b12.getImage(), (int) (b12.getX() + 0.5), 0, b12.getWidth(), b12.getHeight() * 5 / 4, null);
		...
		for (int i = 0; i < fieldList.size(); i++) {
			...
			// 사양을 덜 잡아먹게 하기위한 조치
			if (tempFoot.getX() > -90 && tempFoot.getX() < 1200) { // x값이 -90~1200인 객체들만 그린다.
		...
		for (int i = 0; i < coinList.size(); i++) {
			...
			if (tempCoin.getX() > -90 && tempCoin.getX() < 1200) {

				alphaComposite = AlphaComposite.getInstance(AlphaComposite.SRC_OVER, (float) tempCoin.getAlpha() / 255);
				g2.setComposite(alphaComposite); // 투명하게 하는방법 2

				buffg.drawImage(tempCoin.getImage(), tempCoin.getX(), tempCoin.getY(), tempCoin.getWidth(),
						tempCoin.getHeight(), null);
		...
		for (int i = 0; i < tacleList.size(); i++) {
			...
			if (tempTacle.getX() > -90 && tempTacle.getX() < 1200) {
		...
		if (c1.isInvincible()) { // 무적상태일 경우
			// rabbit의 alpha값을 받아온다
			alphaComposite = AlphaComposite.getInstance(AlphaComposite.SRC_OVER, (float) c1.getAlpha() / 255);
			g2.setComposite(alphaComposite);

			// rabbit를 그린다
			buffg.drawImage(c1.getImage(), c1.getX(), c1.getY() - 88, cookieIc.getImage().getWidth(null),
					cookieIc.getImage().getHeight(null), null);
		...
		// 점수를 그린다
		Util.drawFancyString(g2, Integer.toString(resultScore), 900, 40, 50, new Color(255, 238, 248));

		// 하트를 그린다
		for (int i = 0; i < heartCount; i++) {
			buffg.drawImage(heart.getImage(), 20 + 50 * i, 30, 45, 40, null);
		}
...
//      buffg.drawImage(slideBtn, 650, 360, 132, 100, null);
	...
	// 맵 오브젝트 이미지들을 저장
	private void makeMo() {
//      backIc secondBackIc jelly1Ic jelly2Ic jellyHPIc jellyEffectIc field1Ic field2Ic tacle10Ic tacle20Ic tacle30Ic tacle40Ic

		mo1 = new MapObjectImg(new ImageIcon("img/Objectimg/map1img/back1.png"),
				new ImageIcon("img/Objectimg/map1img/bg2.png"), new ImageIcon("img/Objectimg/map1img/coin.png"),
				new ImageIcon("img/Objectimg/map1img/coin.png"), new ImageIcon("img/Objectimg/map1img/coin.png"),
				new ImageIcon("img/Objectimg/lifebar/heart.png"), new ImageIcon("img/Objectimg/map1img/effectTest.png"),
				new ImageIcon("img/Objectimg/map1img/field3.png"), new ImageIcon("img/Objectimg/map1img/fieldIc2.png"),
				new ImageIcon("img/Objectimg/map1img/enemy1.gif"), new ImageIcon("img/Objectimg/map1img/tacle2.png"),
				new ImageIcon("img/Objectimg/map1img/tacle3.png"), new ImageIcon("img/Objectimg/map1img/tacle3.png"));

		mo2 = new MapObjectImg(new ImageIcon("img/Objectimg/map1img/back2.jpg"),
				new ImageIcon("img/Objectimg/map1img/bg2.png"), new ImageIcon("img/Objectimg/map1img/coin.png"),
				new ImageIcon("img/Objectimg/map1img/coin.png"), new ImageIcon("img/Objectimg/map1img/coin.png"),
				new ImageIcon("img/Objectimg/lifebar/heart.png"), new ImageIcon("img/Objectimg/map1img/effectTest.png"),
				new ImageIcon("img/Objectimg/map1img/field3.png"), new ImageIcon("img/Objectimg/map1img/fieldIc2.png"),
		...
		mo3 = new MapObjectImg(new ImageIcon("img/Objectimg/map1img/back3.jpg"),
				new ImageIcon("img/Objectimg/map1img/bg2.png"), new ImageIcon("img/Objectimg/map1img/coin.png"),
				new ImageIcon("img/Objectimg/map1img/coin.png"), new ImageIcon("img/Objectimg/map1img/coin.png"),
				new ImageIcon("img/Objectimg/lifebar/heart.png"), new ImageIcon("img/Objectimg/map1img/effectTest.png"),
				new ImageIcon("img/Objectimg/map1img/field3.png"), new ImageIcon("img/Objectimg/map1img/fieldIc2.png"),
		...
		mo4 = new MapObjectImg(new ImageIcon("img/Objectimg/map1img/back4.jpg"),
				new ImageIcon("img/Objectimg/map1img/bg2.png"), new ImageIcon("img/Objectimg/map1img/coin.png"),
				new ImageIcon("img/Objectimg/map1img/coin.png"), new ImageIcon("img/Objectimg/map1img/coin.png"),
				new ImageIcon("img/Objectimg/lifebar/heart.png"), new ImageIcon("img/Objectimg/map1img/effectTest.png"),
				new ImageIcon("img/Objectimg/map1img/field3.png"), new ImageIcon("img/Objectimg/map1img/fieldIc2.png"),
	...
	// 메인에서 받은 rabbit 이미지 아이콘들을 인스턴스화
	private void initCookieImg(Rabbitimg ci) {
		// rabbit 이미지 아이콘들
	...
	private void initMap(int num, int mapLength) {
		...
		// 맵 불러와서 색깔 읽기
		if (num == 1) {
			tempMap = "img/map/jmap1.png";
		} else if (num == 2) {
			tempMap = "img/map/jmap2.png";
		} else if (num == 3) {
			tempMap = "img/map/jmap3.png";
		} else if (num == 4) {
			tempMap = "img/map/jmap4.png";
		}
		...
		for (int i = 0; i < maxX; i += 1) { // 코인는 1칸을 차지하기 때문에 1,1사이즈로 반복문을 돌린다.
			for (int j = 0; j < maxY; j += 1) {
				if (colorArr[i][j] == 16776960) { // 색값이 16776960일 경우 기본코인 생성
					// 좌표에 40을 곱하고, 넓이와 높이는 30으로 한다.
					// x, y, width, height, alpha, score
					coinList.add(new Coin(jelly1Ic.getImage(), i * 40 + mapLength * 40, j * 40, 30, 30, 255, 1234));

				} else if (colorArr[i][j] == 13158400) { // 색값이 13158400일 경우 노란코인 생성
					// 좌표에 40을 곱하고, 넓이와 높이는 30으로 한다.
					coinList.add(new Coin(jelly2Ic.getImage(), i * 40 + mapLength * 40, j * 40, 30, 30, 255, 2345));

				} else if (colorArr[i][j] == 9868800) { // 색값이 9868800일 경우 분홍코인 생성
					// 좌표에 40을 곱하고, 넓이와 높이는 30으로 한다.
					coinList.add(new Coin(jelly3Ic.getImage(), i * 40 + mapLength * 40, j * 40, 30, 30, 255, 3456));

				} else if (colorArr[i][j] == 16737280) { // 색값이 16737280일 경우 생명(하트) 생성
					// 좌표에 40을 곱하고, 넓이와 높이는 30으로 한다.
					coinList.add(new Coin(jellyHPIc.getImage(), i * 40 + mapLength * 40, j * 40, 60, 50, 255, 4567));
				}
			}
		}
		...
		for (int i = 0; i < maxX; i += 2) { // 발판은 4칸을 차지하는 공간이기 때문에 2,2사이즈로 반복문을 돌린다.
			for (int j = 0; j < maxY; j += 2) {
				if (colorArr[i][j] == 0) { // 색값이 0 일경우 (검은색)
					...
					// x, y, w, h
					fieldList.add(new Field(field1Ic.getImage(), i * 40 + mapLength * 40, j * 40, 120, 100));
		...
		for (int i = 0; i < maxX; i += 2) { // 장애물은 4칸 이상을 차지한다. 추후 수정
			for (int j = 0; j < maxY; j += 2) {
				if (colorArr[i][j] == 16711680) { // 색값이 16711680일 경우 (빨간색) 1칸
					// 좌표에 40을 곱하고, 넓이와 높이는 80으로 한다.
					tacleList.add(new Tacle(tacle10Ic.getImage(), i * 40 + mapLength * 40, j * 40, 150, 80, 0));
	...
	private void initObject() {
		...
		// 생명게이지 이미지아이콘
		heart = new ImageIcon("img/Objectimg/lifebar/heart.png");
		...
		// rabbit 인스턴스 생성 / 기본 자료는 클래스안에 내장 되어 있기 때문에 이미지만 넣었다.
		c1 = new Rabbit(cookieIc.getImage());

		// rabbit의 정면 위치 / rabbit의 x값과 높이를 더한 값
		face = c1.getX() + c1.getWidth();

		// rabbit의 발밑 위치 / rabbit의 y값과 높이를 더한 값
		...
		// 배경1-2 인스턴스 생성
		b12 = new Back(new ImageIcon("img/Objectimg/map1img/back1-2.png").getImage(), backIc.getImage().getWidth(null),
				0, // y 값 (조정 필요)
	...
	private void initListener() {
		addKeyListener(new KeyAdapter() { // 키 리스너 추가
			...
			public void keyPressed(KeyEvent e) {
				...
				if (!escKeyOn) {
					if (e.getKeyCode() == KeyEvent.VK_SPACE) {// 엔터 키를 누르고 더블점프가 2가 아닐때
					...
					if (e.getKeyCode() == KeyEvent.VK_DOWN) { // 다운키를 눌렀을 때
						...
						if (c1.getImage() != slideIc.getImage() && !c1.isJump() // 점프 중이 아니며
			...
			public void keyReleased(KeyEvent e) {
				...
				if (e.getKeyCode() == KeyEvent.VK_DOWN) { // 다운키를 뗐을 때
					...
					if (c1.getImage() != cookieIc.getImage() // rabbit이미지가 기본이미지가 아니고
							&& !c1.isJump() // 점프 중이 아니며
							&& !c1.isFall()) { // 낙하 중도 아닐 때
	...
	// 화면을 움직이고 코인를 먹거나, 장애물에 부딛히는 등의 이벤트를 발생시키는 메서드
...
//               if (runPage > 8000) { // 800픽셀 이동 마다 체력이 10씩 감소한다
//                  heartCount--;
...
//               }
					...
					// System.out.println("맵 길이 : " + mapLength);

					foot = c1.getY() + c1.getHeight(); // 캐릭터 발 위치 재스캔

					if (foot > 1999 || heartCount < 1) { // 게임 오버
						JumpRabbit.changeCard("over");
						GOverPanel.score = resultScore;
						(new GOverPanel()).insertScore(false);
						superFrame.requestFocus();
						escKeyOn = true;
					}
					if (mapLength > 86000) {
						JumpRabbit.changeCard("clear");
						GClearPanel.score = resultScore;
						...
						if (mapLength > mapLengthList.get(2) * 40 + 800 && b11.getImage() != backIc4.getImage()) {
							...
							new Thread(new Runnable() {
								...
								public void run() {
									...
									b12 = new Back(new ImageIcon("img/Objectimg/map1img/back4-2.jpg").getImage(),
											backIc4.getImage().getWidth(null), 0, backIc4.getImage().getWidth(null),
											backIc4.getImage().getHeight(null));
							...
							new Thread(new Runnable() {
								...
								public void run() {
									...
									b12 = new Back(new ImageIcon("img/Objectimg/map1img/back3-2.jpg").getImage(),
											backIc3.getImage().getWidth(null), 0, backIc3.getImage().getWidth(null),
											backIc3.getImage().getHeight(null));
							...
							new Thread(new Runnable() {
								...
								public void run() {
									...
									b12 = new Back(new ImageIcon("img/Objectimg/map1img/back2-2.jpg").getImage(),
											backIc2.getImage().getWidth(null), 0, backIc2.getImage().getWidth(null),
											backIc2.getImage().getHeight(null));
					...
					for (int i = 0; i < coinList.size(); i++) {
						...
						Coin tempCoin = coinList.get(i); // 임시 변수에 리스트 안에 있는 개별 코인를 불러오자

						if (tempCoin.getX() < -90) { // 코인의 x 좌표가 -90 미만이면 해당 코인를 제거한다.(최적화)

							fieldList.remove(tempCoin);

						} else {

							tempCoin.setX(tempCoin.getX() - gameSpeed); // 위 조건에 해당이 안되면 x좌표를 줄이자
							if (tempCoin.getImage() == jellyEffectIc.getImage() && tempCoin.getAlpha() > 4) {
								tempCoin.setAlpha(tempCoin.getAlpha() - 5);
							}

							foot = c1.getY() + c1.getHeight(); // 캐릭터 발 위치 재스캔

							if ( // 캐릭터의 범위 안에 코인가 있으면 아이템을 먹는다.
							c1.getImage() != slideIc.getImage()
									...
									&& tempCoin.getImage() != jellyEffectIc.getImage()) {

								if (tempCoin.getImage() == jellyHPIc.getImage()) {
								...
								tempCoin.setImage(jellyEffectIc.getImage()); // 코인의 이미지를 이펙트로 바꾼다
								resultScore = resultScore + tempCoin.getScore(); // 총점수에 코인 점수를 더한다

							} else if ( // 슬라이딩 하는 캐릭터의 범위 안에 코인가 있으면 아이템을 먹는다.
							c1.getImage() == slideIc.getImage()
									&& tempCoin.getX() + tempCoin.getWidth() * 20 / 100 >= c1.getX()
									&& tempCoin.getX() + tempCoin.getWidth() * 80 / 100 <= face
									&& tempCoin.getY() + tempCoin.getWidth() * 20 / 100 >= c1.getY()
					...
					for (int i = 0; i < tacleList.size(); i++) {
						...
						if (tempTacle.getX() < -90) {
							...
							fieldList.remove(tempTacle); // 장애물의 x 좌표가 -90 미만이면 해당 코인를 제거한다.(최적화)
	...
	private void hit() {
		new Thread(new Runnable() {
			...
			public void run() {
				...
				c1.setInvincible(true); // rabbit를 무적상태로 전환
...
//            c1.setImage(hitIc.getImage()); // rabbit를 부딛힌 모션으로 변경

				c1.setAlpha(80); // rabbit의 투명도를 80으로 변경
				...
				c1.setAlpha(255); // rabbit의 투명도를 정상으로 변경
				...
				while (true) {
					...
					if (!escKeyOn // 일시중지가 발동 안됐을 때
						...
						if (downKeyOn // 다운키를 누른상태고
								...
								&& c1.getImage() != slideIc.getImage()) { // rabbit 이미지가 슬라이드 이미지가 아닐 경우

							c1.setImage(slideIc.getImage()); // rabbit 이미지를 슬라이드로 변경

						} else if (!downKeyOn // 다운키를 누른상태가 아니고
								&& !c1.isJump() // 점프 상태가 아니고
								&& !c1.isFall() // 낙하 상태가 아니고
								&& c1.getImage() != cookieIc.getImage()) { // rabbit 이미지가 기본 이미지가 아닐 경우
	...
	private void jump() {
		new Thread(new Runnable() {
			...
			public void run() {
				...
				long t1 = Util.getTime(); // 현재시간을 가져온다
				long t2;
				int set = 11; // 점프 계수 설정(0~20) 등으로 바꿔보자
